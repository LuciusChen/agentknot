...
- One accepted positive pair and one seeded defect do not estimate false-positive/false-negative rates or establish a model ranking. Broader route comparisons require comparable workloads and recorded controller disposition before automatic reviewer selection can be proposed.
