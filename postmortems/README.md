...
| [0090](./0090-controller-wait-turn-amplification-pilot.md) | Experiment / Architecture Decision | Accepted / Implemented | Evaluate an explicit long-wait candidate after a controlled Controller pilot |
| [0091](./0091-long-wait-safety-pilot.md) | Experiment / Architecture Decision | Accepted / Implemented | Validate long-wait cancellation and record client compatibility evidence |
