...
3. The admission result is durable but may still be queued. Use non-blocking `agentknot_orchestration_status` later to inspect the terminal handoff. Do not repeatedly list or dump all jobs.
