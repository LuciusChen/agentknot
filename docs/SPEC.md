...
Job terminal success is not WorkOrder acceptance. The minimal `CandidateRecord`, `ReviewRecord`, and `DispositionRecord` remain separate domain records rather than interpretations of Job/Orchestration status or advisory-review evidence. Candidate and Review have explicit WorkOrder-rooted CLI compositions; Disposition remains TypeScript-only. The Review CLI records supplied evidence and never launches a reviewer or infers a verdict.
