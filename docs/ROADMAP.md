...
- Continue repeated per-adapter real-worker soaks. Pi remains the promoted reference/default; native OpenCode remains manually selected and experimental until real failure/cancellation/timeout repetitions and cleanup evidence close the gate.
