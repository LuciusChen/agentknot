...
export const MAX_HANDOFF_ERROR_BYTES = 2 * 1024;
export const MAX_HANDOFF_COMPLETION_ITEMS = 20;
export const MAX_HANDOFF_COMPLETION_TEXT_BYTES = 256;
export const MAX_ORCHESTRATION_HANDOFF_BYTES = 32 * 1024;
export const MAX_HANDOFF_ROUTE_IDENTITY_BYTES = 256;
export const MIN_HANDOFF_ERROR_MESSAGE_BYTES = 128;
export const DEFAULT_OUTPUT_CHUNK_BYTES = 4 * 1024;
export const MIN_OUTPUT_CHUNK_BYTES = 4;
export const MAX_OUTPUT_CHUNK_BYTES = 16 * 1024;
...
export const MAX_DISPOSITION_RECORD_BYTES = 16 * 1024 * 1024;
